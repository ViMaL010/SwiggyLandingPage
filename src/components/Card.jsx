...
export  default function Card(props){
    return <div className="w-full md:w-[273px] shrink-0">
            ...
            <div className="mt-3 text-md md:text-2xl font-semibold ">
                {props.title}
            </div>
            ...
            <div className="text-[18px] text-[#686b78]">
                {props.name}
            </div>
            <div className="text-[18px] text-[#686b78] mb-2">
                {props.place}
            </div>
        </div>
}
